...
import { Mail, Lock, Eye, EyeOff, Watch, ArrowRight, AlertCircle } from "lucide-react";
...
export default function SignInPage() {
  ...
  const handleSocialSignIn = async (provider) => {
    ...
    try {
      ...
      const msg = `Failed to sign in with ${provider}.`;
      setErrorMsg(msg);
      toast.error(msg);
    }
  };
  ...
  return (
    <PageTransition className="min-h-screen bg-[var(--color-cream)] flex items-center justify-center px-5 py-28 sm:py-32 relative">
      ...
      <div className="w-full max-w-[440px] relative z-10 mx-auto">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between pt-1">
              <label className="flex items-center gap-2 cursor-pointer group">
                <input
                  ...
                  onChange={handleChange}
                  className="w-4 h-4 rounded border-[#c5a56e]/30 text-[#1a4d2e] focus:ring-[#c5a56e]/30 accent-[#1a4d2e] cursor-pointer"
                />
                <span className="text-[12px] text-[#1a1a1a]/50 group-hover:text-[#1a1a1a]/80 transition-colors" style={{ fontFamily: "var(--font-geist)" }}>
                  Remember me
                </span>
              </label>
              <a href="#" className="text-[12px] text-[#c5a56e] hover:text-[#1a4d2e] font-medium transition-colors" style={{ fontFamily: "var(--font-geist)" }}>
                Forgot password?
              </a>
            </div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-3.5 mt-2 bg-[#1a4d2e] text-white rounded-xl text-[11px] tracking-[0.2em] uppercase font-semibold disabled:opacity-60 shimmer-hover flex items-center justify-center gap-2 cursor-pointer shadow-lg shadow-[#1a4d2e]/10"
              style={{ fontFamily: "var(--font-geist)" }}
            >
              {loading ? (
        ...
        >
          ...
          <Link href="/auth/register" className="text-[#c5a56e] hover:text-[#1a4d2e] font-semibold transition-colors duration-300">
            Create one
          </Link>
        </motion.p>
      </div>
